...
<svg width="${width}" height="44" viewBox="0 0 ${width} 44" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	<rect x="1" y="1" width="${
    width - 2
  }" height="42" rx="7" fill="#${backgroundColour}"/>
	<rect x="1" y="1" width="${
    width - 2
  }" height="42" rx="7" fill="black" fill-opacity="0.7"/>
	<rect x="1" y="1" width="${
    width - 2
  }" height="42" rx="7" fill="url(#paint0_linear_1_99)" fill-opacity="0.3" style="mix-blend-mode:overlay"/>
	<rect x="1" y="1" width="${
    width - 2
  }" height="42" rx="7" stroke="#${backgroundColour}" stroke-width="2"/>
	<rect x="1" y="1" width="${
    width - 2
  }" height="42" rx="7" stroke="black" stroke-opacity="0.3" stroke-width="2"/>
	...
	<defs>
		...
		<image id="image0_1_99" width="512" height="512" xlink:href="${imageUrl}" />
	</defs>
</svg>
`;
