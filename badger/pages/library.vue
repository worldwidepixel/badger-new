<template>
	...
	<div class="flex flex-col gap-4 p-4">
		...
		<div class="flex flex-col gap-2" v-for="dataGroup in libraryData">
			...
			<span class="font-[500] text-xl"> {{ getKeyByValue(libraryData, dataGroup) }} </span>

			<div class="flex flex-row flex-wrap gap-2">

				<libraryCard v-for="badge in dataGroup" :name="getKeyByValue(dataGroup, badge)" :badge="badge" />
...
const libraryData = await $fetch("/internal/library")
